namespace Logger
{
    ...
    void Log(string szContent, string a, string b)
    {
        g_Log.PrintF( "[" + g_Module.GetModuleName() + "] " + szContent.Replace("{0}", a).Replace("{1}", b) + "\n");
    }
    void Log(string szContent, string a)
    {
        g_Log.PrintF( "[" + g_Module.GetModuleName() + "] " + szContent.Replace("{0}", a) + "\n");
    }
